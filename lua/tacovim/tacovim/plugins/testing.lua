...
return {
  ...
  -- SNAPSHOT TESTING
  -- =============================================================================
  -- E2E plugin disabled - repository not found
  -- {
  --   "gootorov/e2e.nvim",
  --   ft = { "javascript", "typescript" },
  --   keys = {
  ...
  -- =============================================================================
  -- ULTEST (DEPRECATED - DISABLED IN FAVOR OF NEOTEST)
  -- =============================================================================
  -- vim-ultest is deprecated, use neotest instead
  -- To disable the deprecation warning, we set the global variable
  -- {
  --   "rcarriga/vim-ultest",
