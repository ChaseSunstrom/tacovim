    ...
    opts = {
      mappings = {
        i = {
          ["<CR>"] = { 
            action = function(...)
              local ok, actions = pcall(require, "toggleterm-manager.actions")
              if ok then
                return actions.toggle_term(...)
              end
            end,
    ...
    opts = {
      ...
      mapping = {
        n = {
          ...
          S = false,
                ["<C-s>"] = function(...)
        local ok, term_edit = pcall(require, "term-edit")
        if ok then
          return term_edit.send_lines(...)
        end
      end,
      ["<C-S>"] = function(...)
        local ok, term_edit = pcall(require, "term-edit")
        if ok then
          return term_edit.send_lines_split(...)
        end
      end,
        },
        x = {
        ...
        local ok, term_edit = pcall(require, "term-edit")
        if ok then
          return term_edit.send_selection(...)
        end
      end,
      ["<C-S>"] = function(...)
        local ok, term_edit = pcall(require, "term-edit")
        if ok then
          return term_edit.send_selection_split(...)
        end
      end,
        },
      },
