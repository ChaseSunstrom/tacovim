...
return {
  ...
  -- =============================================================================
  {
    ...
    keys = {
      ...
      { "<leader>sC", function() require("spectre").open_visual({ select_word = true }) end, desc = "Search Current Word", mode = "v" },
      { "<leader>sF", function() require("spectre").open_file_search({ select_word = true }) end, desc = "Search in Current File" },
      { "<leader>sV", function() require("spectre").open_visual() end, desc = "Search Selected Text", mode = "v" },
    },
    opts = {
      color_devicons = true,
      open_cmd = "vnew",
  ...
  -- =============================================================================
  {
    ...
    keys = {
      ...
      { "g#", [[g#<Cmd>lua require('hlslens').start()<CR>]] },
              -- Clear highlights moved to core keymaps
    },
    opts = {
  ...
  -- =============================================================================
  {
    ...
    keys = {
      ...
      -- Remove conflicting search/replace keymaps since we have better ones
    },
    opts = {
      popup = {
        relative = "win",
