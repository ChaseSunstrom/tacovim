...
local plugins = {
  ...
  -- 📖 ENHANCED SYMBOL OUTLINE & STRUCTURE
  {
  ...
  -- Enhanced Treesitter
  {
    ...
    opts = {
      ensure_installed = {
        ...
        "java", "php", "ruby", "yaml", "toml", "dockerfile", "tsx", -- "jsx" REMOVE JSX
  ...
  -- Which-key (Pinned to v2)
  {
    "folke/which-key.nvim",
    version = "^2", -- Pin to version 2.x
    event = "VeryLazy",
    opts = {
      plugins = {
        marks = true,
  ...
  -- 🐛 ENHANCED VISUAL STUDIO-LIKE DEBUGGING
  {
    ...
    keys = {
      ...
      -- Telescope integration (simplified)
    ...
    config = function()
      ...
      dapui.setup({
        ...
        layouts = {
          {
            elements = {
              -- FIXED: Use simple format for elements
              "scopes",
              "breakpoints",
              "stacks",
              "watches",
            },
            size = 40, -- FIXED: Use number not table
            position = "left",
          },
          {
            elements = {
            ...
            size = 10, -- FIXED: Use number not table
            position = "bottom",
          },
        },
        controls = {
          enabled = true,
          element = "repl", -- FIXED: Ensure element exists
          icons = {
            pause = "⏸",
            play = "▶",
            step_into = "⏬",
