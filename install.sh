...
# Configuration
TACOVIM_REPO="https://github.com/ChaseSunstrom/tacovim.git"
TACOVIM_BRANCH="master"
...
show_final_instructions() {
    ...
    echo -e "${WHITE}• Documentation:${NC} https://github.com/ChaseSunstrom/tacovim"
    echo -e "${WHITE}• Issues:${NC} https://github.com/ChaseSunstrom/tacovim/issues"
